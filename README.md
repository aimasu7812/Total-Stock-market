...
最新値タブの上段では、現在PER、日経平均EPS（`日経平均 ÷ PER`）、PER20倍から30倍までの日経平均水準、PBR、空売り比率合計、投資主体別売買動向の主要3項目、VIX指数、信用損益率、日経平均、TOPIX、NT倍率を優先表示します。空売り比率合計が40%を超えた場合は緑色、VIXが20超で黄色・30超で赤色、信用損益率が10%超で赤色に強調します。投資主体別売買動向はプラスを緑、マイナスを赤で表示します。
